...
def all_users(search, status, roll, page, limit, db):
	...
	users=db.query(Users).options(joinedload(Users.savdo),joinedload(Users.savdolar),joinedload(Users.sotish),joinedload(Users.sot),joinedload(Users.sotil),joinedload(Users.sotil),joinedload(Users.soti),joinedload(Users.so),joinedload(Users.s)).filter(search_filter, status_filter, roll_filter).order_by(Users.name.asc())
	if page and limit:
